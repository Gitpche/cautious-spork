...
namespace MyMod.Content.Biomes
{
	...
	public override int ChooseFarTexture()
    		=> BackgroundTextureLoader.GetBackgroundSlot("MyMod/Content/Backgrounds/AstralFar");

	public override int ChooseMiddleTexture()
    		=> BackgroundTextureLoader.GetBackgroundSlot("MyMod/Content/Backgrounds/AstralMiddle");

	public override int ChooseCloseTexture(ref float scale, ref double parallax, ref float a, ref float b)
    		=> BackgroundTextureLoader.GetBackgroundSlot("MyMod/Content/Backgrounds/AstralClose");
